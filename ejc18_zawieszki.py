...
def write_preamble(fname):
    preamble = r"""%18 EJC technology, (C) LM 2019
...
def write_player(p, f, photo):
    ...
    if dan == "-1":
        dan = "{\color{white}1}"
    elif dan.lower() == "mudan" or dan.lower() == "0":
        dan = "mudan"
    elif "renshi" in dan:
...
if __name__ == "__main__":
    ...
    #     ekf = player[5].replace("\n","")
    #     print(player, is_in_foto_dir(ekf))
    #
    # if 0:§
        country = player[0]
        cou = country[:3].lower()
        ...
        print(cou, fname, lname, dan, role, ekf)
